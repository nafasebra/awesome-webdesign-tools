...
- [ShrinkKit](https://p32929.github.io/shrinkkit/) - Bulk image compressor that runs fully in the browser — resize, convert to WebP/JPEG/PNG and strip EXIF/GPS from a whole folder, then download as a ZIP. No upload.
